...
|birthDate|User's date of birth.|false|string (date)||
...
|schoolId|The corresponding school|false|string||
|token|Token used in user invitations to be a school employee.|false|string||
...
|schedules|A list of generator schedules.|true|Schedule array||
